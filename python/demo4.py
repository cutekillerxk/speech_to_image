...
DISPLAY_CONFIG = {
    ...
    "custom_height": 1400,  # 像素
    "custom_width": 1400,  # 像素
    # 屏幕信息（可选，用于预设）
    "screen_size": "27.1inch",  # 27.1英寸，598mm*336mm
}
...
def get_image_size():
    ...
    if mode == "custom":
        return DISPLAY_CONFIG.get("custom_height", 1400), DISPLAY_CONFIG.get("custom_width", 1400)
    elif mode == "fit_height":
        # 以高度为准，适合 27.1 英寸屏幕（通常 2560x1440 或 3840x2160）
        # 使用适合大屏幕的尺寸，保持 1:1 比例
        return 1400, 1400  # 27.1英寸显示器推荐尺寸
    elif mode == "fit_width":
        # 以宽度为准，适合 27.1 英寸屏幕
        return 1600, 1600
    else:  # fit_screen
    ...
    return 1400, 1400  # 默认值（27.1英寸显示器）
